...
app.post('/signupSubmit', async (req,res) => {
    ...
    const validationResult = schema.validate({username, displayname, email, password, birthdate});
	...
	if (validationResult.error != null) {
       ...
       res.render("submitError", {errormessage: errormessage});
        ...
        await userCollection.insertOne({username: username, displayname: displayname, email: email, password: hashedPassword, user_type: "user", birthdate: birthdate});
        console.log("User Created:" + username);
